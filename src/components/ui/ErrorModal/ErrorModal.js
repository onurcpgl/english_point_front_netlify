    ...
    <div className="fixed inset-0  flex items-center justify-center z-50">
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg w-96 z-50">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-bold text-black">Hata</h2>
        ...
        <button
          onClick={onClose}
          className="mt-4 w-full bg-red-500 text-white py-2 rounded-lg hover:scale-105 transition-all cursor-pointer"
        >
          Kapat
        </button>
      </div>
