...
export default function InstructorCreateSession() {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      sub_category_id: Yup.string().test(
        ...
        "Please select a field", // Hata mesajı
        function (value) {
          // Eğer kategori ID'si 2 ise değer dolu olmalı
  ...
  const activePrograms = useMemo(() => {
    ...
    // 2. Eğer BUSINESS seçildiyse ve ALT KATEGORİ seçildiyse SLUG'a göre filtrele
    if (Number(selectedCategoryId) === 2) {
      ...
      if (selectedSubId) {
        ...
        // Business seçili ama alt konu seçilmediyse program listesi boş gelsin mi?
        // İstersen burayı `return []` yapabilirsin. Şu an hepsi gelir.
      }
    }
  ...
  // Eğer veri henüz yüklenmediyse veya business yoksa boş dizi döndürüyoruz.
      ...
      <form onSubmit={formik.handleSubmit} className="space-y-6 p-3 max-lg:p-0">
        <div className="w-full space-y-6 px-4">
          <div className="space-y-4">
            ...
            {/* --- Sub-Topic Select (Sadece ID 2 ise görünür) --- */}
              ...
              <div className="space-y-2 animate-fadeIn mt-4">
                ...
                <div className="relative">
                  <select
                    ...
                    className={`w-full h-14 rotate-0 focus:rounded-0 outline-0 px-4 placeholder:text-[#8e8e8e] bg-white font-light text-black border ${
                  ...
                  >
                    ...
                    {/* Artık dinamik subTopics listesini dönüyoruz */}
                    {subTopics.map((topic) => (
                  ...
                  {(selectedProgram.video_url ||
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        {selectedProgram.voice_path && (
                          <a
                            href={selectedProgram.voice_path}
                            target="_blank"
                            rel="noreferrer"
                        ...
                        {selectedProgram.document_path && (
                          <a
                            href={selectedProgram.document_path}
                            target="_blank"
                            rel="noreferrer"
